  ...
  return (
    <>
      ...
      <div className="main-content">
        <h1>Chính xác và quyền riêng tư </h1>
        <div
          style={{
            marginTop: 80,
          }}
        >
          ...
          <b>Thu thập thông tin cá nhân</b>
          <div className="des">
          ...
          <b>Điều chỉnh thông tin cá nhân</b>
          <div className="des">
