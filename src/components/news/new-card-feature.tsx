  ...
  return (
    <div className="flex flex-row items-center p-0 gap-6">
      ...
      <div className="flex-1 lg:flex-2 flex flex-col items-start p-0">
        <div className="font-normal text-sm leading-[150%] text-[#717171]">25/07/2022</div>
        <div className="font-medium text-xl leading-[150%] text-primary-color hover:cursor-pointer">
